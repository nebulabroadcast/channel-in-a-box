...
async def validate(
    ...
    if asset["id_folder"] == Folder.DATASET:
        ...
        # When adding a serie, update a classification scheme as well,
        # so we have the serie available in the episode's "serie" selection
        ...
        # TODO: Reload all replica settings
